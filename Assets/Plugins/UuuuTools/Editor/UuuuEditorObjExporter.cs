...
// This obj exporter is taken directly from the unity wiki at:
// http://wiki.unity3d.com/index.php/ExportOBJ
// It has been change to use AssetDatabase instead of the older obsolete call, to prevent warnings from Unity
...
public class UuuuEditorObjExporter : ScriptableObject
{
    ...
    //[MenuItem ("UuuuTools/Export/Export all MeshFilters in selection to separate OBJs")]
    ...
    //[MenuItem ("UuuuTools/Export/Export whole selection to single OBJ")]
